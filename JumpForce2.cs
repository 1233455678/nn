...
public class JumpForce2 : MonoBehaviour
{
...
void Update2() // Обновляет скрипт каждый кадр
    {
        if (isGrounded == true && Input.GetKeyDown(KeyCode.X)) // Проверяет, на земле ли игрок и была ли нажата кнопка прыжка
            {
